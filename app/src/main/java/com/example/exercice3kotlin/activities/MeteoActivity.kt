...
import com.example.exercice3kotlin.databinding.ActivityMeteoBinding
import com.example.exercice3kotlin.models.WeatherModel
import com.example.exercice3kotlin.utils.ApiUtilities
...
class MeteoActivity : AppCompatActivity() {
    ...
    lateinit var binding: ActivityMeteoBinding
                ...
                override fun onResponse(call: Call<WeatherModel>, response: Response<WeatherModel>) {
                    if (response.isSuccessful){
                        ...
                        if (mInterstitialAd!=null){
                            ...
                            mInterstitialAd!!.show(this@MeteoActivity)
                        ...
                        Toast.makeText(this@MeteoActivity, "No City Found",
            ...
            when (id) {
                ...
                in 200..232 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@MeteoActivity, R.drawable.thunderstrom_bg)
                ...
                in 300..321 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@MeteoActivity, R.drawable.drizzle_bg)
                ...
                in 500..531 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@MeteoActivity, R.drawable.rain_bg)
                ...
                in 600..622 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@MeteoActivity, R.drawable.snow_bg)
                ...
                in 701..781 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@MeteoActivity, R.drawable.atmosphere_bg)
                ...
                800 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@MeteoActivity, R.drawable.clear_bg)
                ...
                in 801..804 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@MeteoActivity, R.drawable.clouds_bg)
                ...
                //unknown
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@MeteoActivity, R.drawable.unknown_bg)
