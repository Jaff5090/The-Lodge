...
class Fragmenthistory : Fragment() {
    ...
    private val questions = mutableListOf<FragmentAnimals.Question>()
    ...
    override fun onCreateView(
        ...
        if (!jsonString.isNullOrEmpty()) {
            val gson = Gson()
            questions.addAll(gson.fromJson(jsonString, Array<FragmentAnimals.Question>::class.java).toList())
        } else {
